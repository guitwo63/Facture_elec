...
final class AuditActionLabelStoreTests: XCTestCase {
    ...
    func testDefaultLabelsCoverKnownActionCodes() {
        ...
        let knownCodes = [
            ...
            "pdp_status_error", "pdp_status_send_error", "pdp_status_recovered",
            "purchase_invoice_created", "purchase_invoice_updated", "purchase_invoice_deleted",
            "purchase_invoice_received", "purchase_invoice_receive_error",
            "purchase_invoice_list_error", "purchase_invoice_list_recovered",
            "purchase_pdp_status_sent", "purchase_pdp_status_error",
