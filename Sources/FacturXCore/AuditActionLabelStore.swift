...
public final class AuditActionLabelStore: ObservableObject {
    ...
    public static let defaultLabels: [AuditActionLabel] = [
        ...
        AuditActionLabel(id: "pdp_status_recovered", label: "Interrogation PDP rétablie"),
        AuditActionLabel(id: "purchase_invoice_created", label: "Facture d'achat créée"),
        AuditActionLabel(id: "purchase_invoice_updated", label: "Facture d'achat modifiée"),
        AuditActionLabel(id: "purchase_invoice_deleted", label: "Facture d'achat supprimée"),
        AuditActionLabel(id: "purchase_invoice_received", label: "Facture d'achat reçue par PDP"),
        AuditActionLabel(id: "purchase_invoice_receive_error", label: "Import d'une facture reçue échoué"),
        AuditActionLabel(id: "purchase_invoice_list_error", label: "Réception PDP échouée"),
        AuditActionLabel(id: "purchase_invoice_list_recovered", label: "Réception PDP rétablie"),
        AuditActionLabel(id: "purchase_pdp_status_sent", label: "Statut PDP envoyé au fournisseur"),
        AuditActionLabel(id: "purchase_pdp_status_error", label: "Envoi du statut PDP au fournisseur échoué"),
