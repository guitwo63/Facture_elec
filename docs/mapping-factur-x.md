...
| `seller.endpointID` | `ram:SellerTradeParty/ram:URIUniversalCommunication/ram:URIID` (schéma choisi, BT-34-1 : 0225 annuaire par défaut, 0009 SIRET, 9957 n° TVA français, EM e-mail ; déduit du SIREN en 0225 si vide) | BT-34 | BR-FR-13 (SIREN ou identifiant électronique), BR-FR-23 (caractères admis en schéma 0225) | erreur |
...
| `buyer.endpointID` | `ram:BuyerTradeParty/ram:URIUniversalCommunication/ram:URIID` (schéma choisi, BT-49-1 : 0225 annuaire par défaut, 0009 SIRET, 9957 n° TVA français, EM e-mail ; déduit du SIREN en 0225 si vide) | BT-49 | BR-FR-12 (SIREN ou identifiant électronique), BR-FR-23 (caractères admis en schéma 0225), BR-FR-21 (destinataire français à SIREN hors de l'annuaire) | erreur / avertissement (BR-FR-21) |
