...
| `seller.endpointID` | `ram:SellerTradeParty/ram:URIUniversalCommunication/ram:URIID` (schéma choisi, BT-34-1 : 0225 annuaire par défaut, 0009 SIRET, 9957 n° TVA français, EM e-mail ; déduit du SIREN en 0225 si vide) | BT-34 | BR-FR-13 (SIREN ou identifiant électronique), BR-FR-23 (caractères admis en schéma 0225), BR-FR-25 (125 caractères au plus, tout schéma) | erreur |
...
| `buyer.siren` | `ram:BuyerTradeParty/ram:SpecifiedLegalOrganization/ram:ID` (schéma 0002) | BT-47 | BR-FR-32 (exactement 9 chiffres ; BR-FR-11 ne vaut qu'avec une note BAR = B2B, non émise), BT-47-LUHN (clé Luhn, contrôle interne), BR-FR-12 (SIREN ou identifiant électronique) | erreur (mal formé) / avertissement (clé) / erreur (ni l'un ni l'autre) |
| `buyer.siret` | — (non émis ; serait le BT-46, schéma 0009) | — | BR-FR-09 (14 chiffres, clé Luhn) | avertissement |
| `buyer.endpointID` | `ram:BuyerTradeParty/ram:URIUniversalCommunication/ram:URIID` (schéma choisi, BT-49-1 : 0225 annuaire par défaut, 0009 SIRET, 9957 n° TVA français, EM e-mail ; déduit du SIREN en 0225 si vide) | BT-49 | BR-FR-12 (SIREN ou identifiant électronique), BR-FR-23 (caractères admis en schéma 0225), BR-FR-25 (125 caractères au plus, tout schéma), BR-FR-21 (destinataire français à SIREN hors de l'annuaire) | erreur / avertissement (BR-FR-21) |
...
| BR-FR-21 | identifiant électronique destinataire (BT-49) | avertissement | Destinataire établi en France, à SIREN (schéma 0002, 9 chiffres), dont l'adresse émise n'est pas sous le schéma 0225 de l'annuaire (EM, 0009, 9957…) : la PDP l'exige entre entreprises françaises assujetties ; le Schematron ne l'applique qu'avec une note BAR = B2B, non émise ; facture émise seulement |
