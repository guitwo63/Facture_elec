...
| `seller.endpointID` | `ram:SellerTradeParty/ram:URIUniversalCommunication/ram:URIID` (schéma choisi, BT-34-1 : 0225 annuaire par défaut, 0009 SIRET, 9957 n° TVA français, EM e-mail ; déduit du SIREN en 0225 si vide) | BT-34 | BR-FR-13 (SIREN ou identifiant électronique), BR-FR-23 (caractères admis en schéma 0225), BR-CL-25 (schéma de la liste EAS) | erreur (BR-CL-25 : avertissement sur une facture reçue) |
...
| `buyer.endpointID` | `ram:BuyerTradeParty/ram:URIUniversalCommunication/ram:URIID` (schéma choisi, BT-49-1 : 0225 annuaire par défaut, 0009 SIRET, 9957 n° TVA français, EM e-mail ; déduit du SIREN en 0225 si vide) | BT-49 | BR-FR-12 (SIREN ou identifiant électronique), BR-FR-23 (caractères admis en schéma 0225), BR-CL-25 (schéma de la liste EAS), BR-FR-21 (adresse 0225 qui ne désigne pas le SIREN ; destinataire français à SIREN hors de l'annuaire) | erreur / avertissement (BR-FR-21 hors de l'annuaire ; BR-CL-25 sur une facture reçue) |
